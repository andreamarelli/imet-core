...
return [
    ...
    'GeneralInfo' => [
        'title' => 'Basic data',
        'fields' => [
            'CompleteName' => 'Full name of the IMET conserved area',
            'UsedName' => 'Name by which IMET conserved area is referred to',
            ...
            'Ownership' => 'IMET conserved area ownership type',
        ...
        'module_info' => '<b>Introduction to typology</b>: IMET identifies three categories of conserved areas: (1) Terrestrial protected area (2)
            Marine and Coastal protected area (3) IMET conserved area - Other Effective Conservation Measures (IMET conserved area).<br />
            This IMET analyses the management of an IMET conserved area defined as “A geographically defined area other than a Protected Area,
            ...
            and other locally relevant values” (CBD, 2018). IMET conserved areas include community forests,
            indigenous peoples and community conserved territories and areas (ICCAs), locally managed marine areas (LMMAs),
            and many other types of conserved areas.<br/> What is the difference between a protected area and an IMET conserved area? (Source WDPA)
            Protected areas and IMET conserved areas have many similarities, such as the requirement of a geographically-defined boundary and a long-term commitment.
            But while protected areas are places designated to achieve positive biodiversity outcomes,
            the term ‘IMET conserved area’ applies to areas designated for any purpose, where positive biodiversity outcomes occur regardless of the original management objectives.
            In a protected area, conservation must be the primary, or joint-primary, objective.
            In an IMET conserved area, it may be a secondary objective or not an explicit objective at all.<br/>
            IMET conserved areas also encompass areas that meet the definition of a protected area,
            in cases where the governance authority prefers the area to be considered an IMET conserved area.<br/>
    ...
    'Governance' => [
        ...
        'fields' => [
            ...
            'ManagementUnique' => 'Determine the entity in charge of the management and governance of the IMET conserved area',
            'ManagementName' => 'Name',
            'ManagementType' => 'Type',
        ...
        'ratingLegend' => [
            'MemberRepresentativenessLevel' => [
                '0' => 'Less than 30% of the total population of the IMET conserved area ',
                '1' => '30–50% total population of the IMET conserved area ',
                '2' => '51–75% total population of the IMET conserved area ',
                '3' => 'More than 75% of the total population of the IMET conserved area ',
            ]
        ]
    ],
    ...
    'Networks' => [
        ...
        'fields' => [
            'NetworkName' => 'Name',
            'ProtectedAreas' => 'Names of other IMET conserved areas or protected area within the network',
        ],
        'groups' => [
            'group0' => 'Transboundary network',
            'group1' => 'Landscape network (terrestrial and marine IMET conserved areas)',
    ...
    'Contexts' => [
        'title' => 'References of historical, political, legal and institutional and socio-economic contexts of the IMET conserved area',
        'fields' => [
    ...
    'Objectives1' => [
        'module_info' => 'Establish and describe conservation objectives for the governance, partnerships and the designation <b>of the IMET conserved area</b><br /> The objectives entered below will be used for improving management, and more specifically for the planning, resource (input) mobilisation, process phases, and for monitoring management activities of the IMET conserved area'
    ],

    'Objectives2' => [
        'module_info' => 'Establish and describe conservation objectives for <b>the area of the IMET conserved area</b><br /> The objectives entered below will be used for improving management, and more specifically for the planning, resource (input) mobilisation, process phases, and for monitoring management activities of the IMET conserved area'
    ],

    'Objectives3' => [
        'module_info' => 'Establish and describe conservation objectives for <b>human and financial resources/support from partnerships in managing </b>of the IMET conserved area<br/> The objectives entered below will be used for improving management, and more specifically for the planning, resource (input) mobilisation, process phases, and for monitoring management activities of the IMET conserved area'
    ],

    'Objectives4' => [
        'module_info' => 'Establish and describe conservation objectives for <b>key animals and plant species</b>of the IMET conserved area<br/> The objectives entered below will be used for improving management, and more specifically for the planning, resource (input) mobilisation, process phases, and for monitoring management activities of the IMET conserved area'
    ],
    ...
    'GeographicalLocation' => [
        ...
        'fields' => [
            ...
            'SourceCoords' => 'Source',
            'AdministrativeLocation' => 'Administrative location of the IMET conserved area (province, region, etc.)',
        ]
    ],

    'Areas' => [
        'title' => 'Surface area of the IMET conserved area and conservation context',
        'fields' => [
            'AdministrativeArea' => 'Administrative surface',
            'WDPAArea' => 'Surface according to WDPA',
            'GISArea' => 'Actual surface (GIS for the park or the authority responsible for IMET conserved areas) corresponding to the uploaded file',
            'StrictConservationArea' => 'Surface of strict conservation area (no-take zone, core zone) (if any) ',
            'TerrestrialArea' => 'Surface of Terrestrial IMET conserved area, Community Forest, ICCAs, Other',
            'MarineArea' => 'Surface of Marine and coastal IMET conserved area, ICCAs, LMMA, Other'
        ]
    ],
    ...
    'ManagementStaff' => [
        ...
        'module_info' => 'Number and categories of members of the IMET conserved area Management Entity',
    ...
    'FinancialResources' => [
        ...
        'module_info' => 'Estimated total management costs of the IMET conserved area '
    ],
    ...
    'Equipments' => [
        ...
        'groups' => [
            ...
            'group8' => 'Waterways',
            'group9' => 'Links and connections of the IMET conserved area with the outer world'
        ],
        'predefined_values' => [
            ...
            'group7' => ['Roads/tracks inside the IMET conserved area', 'Paths inside the IMET conserved area', 'Road along the border'],
            'group8' => ['Waterways inside the IMET conserved area'],
    ...
    'Habitats' => [
        'title' => 'Habitats main categories in the IMET conserved area',
        'fields' => [
            'EcosystemType' => 'Habitats types',
            'EcosystemDescription' => 'Description for the specific IMET conserved area',
            'ExploitedSpecies' => 'EXP',
            'ProtectedSpecies' => 'PRT',
            'DisappearingSpecies' => 'DSG',
            'PopulationEstimation' => 'Estimated status',
    ...
    'Stakeholders' => [
        ...
        'fields' => [
            'Element' => 'Stakeholder',
            'GeographicalProximity' => 'Living inside or in proximity to the IMET conserved area (less than one hour\'s walk)',
            'UsesCategories' => 'Categories of uses or management of IMET conserved area’s key elements',
            'DirectUser' => 'Direct users of IMET conserved area’s key elements',
            'LevelEngagement' => 'Level of engagement in IMET conserved area’s key elements management',
            'LevelInterest' => 'Level of interest in preserving the IMET conserved area’s key elements',
            'LevelExpertise' => 'Level of expertise in management of the IMET conserved area’s key elements (including traditional or indigenous knowledge)',
            'Comments' => 'Note',
        ],
        'titles' => [
        ...
        'module_info' =>
            'Identify the stakeholders involved in the management or use of the natural resources of the IMET conserved area<br />
            <b>Living inside or in proximity to the IMET conserved area</b>: Living in or near a conserved area can provide access to important
            ecosystem services but might also require restrictions and regulations.<br />
            <b>Categories of uses or management of IMET conserved area’s key elements</b>: Various ways in which stakeholders interact with
            animals, plants or habitats (Biodiversity) and benefit from ecosystem services (Provisioning, Cultural, Regulating,
            Supporting) provided by the IMET conserved area.<br />
            <b>Direct users of IMET conserved area’s key elements</b>: Direct Users are those who directly benefit from the goods and services
            provided by the conserved area.<br />
            <b>Level of interest in preserving the IMET conserved area’s key elements</b>: Degree to which stakeholder is interested in the IMET conserved area’s
            ...
            <b>Level of expertise in management of the IMET conserved area’s key elements (including traditional or indigenous knowledge)</b>: Degree to
            which a stakeholder has necessary knowledge, skills, and experience to effectively manage and conserve some key elements
            of the IMET conserved area. Expertise can be from traditional and indigenous knowledge, historical practices, long-term observations,
        ...
        'ratingLegend' => [
            ...
            'LevelInterest' => [
                '0' => 'No interest in IMET conserved area conservation',
                '1' => 'Low interest in IMET conserved area conservation',
                '2' => 'Moderate interest in IMET conserved area conservation',
                '3' => 'High interest in IMET conserved area conservation',
            ],
            'LevelExpertise' => [
    ...
    'StakeholdersObjectives' => [
        'module_info' =>
            ...
            natural resources of the IMET conserved area. The objectives entered below will be used for improving management, and more specifically
            for the planning, resource (input) mobilisation, process phases, and for monitoring management activities of the IMET conserved area.'
    ],
    ...
    'AnalysisStakeholderDirectUsers' => [
        ...
        'module_info' =>
            ...
            '<b>Threats</b>: Human activities or processes that have impacted, are impacting or may impact the IMET conserved area’s key element
                 being assessed.</br >',
        'ratingLegend' => [
            'Dependence' => [
    ...
    'AnalysisStakeholderIndirectUsers' => [
        ...
        'fields' => [
            ...
            'Status' => 'Status of IMET conserved area’s key elements',
            'Trend' => 'Trend of IMET conserved area’s key elements',
            'Threats' => 'Threats',
            'Comments' => 'Note',
        ],
        'module_info' =>
            ...
            '<b>Lack of collaboration between non-direct and direct users</b>: Absence or insufficient coordination among
                ...
                practices</br >' .
            '<b>Status of IMET conserved area’s key elements</b>: Status of the key elements indicates the status of the provision of ecosystem
                ...
                in the IMET conserved area . Very good status indicates that the key element is of good quality or expanding. Various
                environmental factors such as climate and weather, land use change, pollution, and overexploitation of resources,
                overexploitation can affect the status of IMET conserved area’s key elements.</br >' .
            '<b>Trend of IMET conserved area’s key elements</b>: Current trends of the key elements indicate the change in the quantity of
            ...
            '<b>Threats</b>: Human activities or processes that have impacted, are impacting or may impact the IMET conserved area’s
    ...
    'AnalysisStakeholdersObjectives' => [
        'module_info' =>
            'Establish and describe conservation objectives for the stakeholders analysis of the key elements of the IMET conserved area.
            The objectives entered below will be used for improving management, and more specifically for the planning,
            resource (input) mobilisation, process phases, and for monitoring management activities of the IMET conserved area.'
    ],
