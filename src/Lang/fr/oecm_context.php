...
return [
    ...
    'GeneralInfo' => [
        ...
        'fields' => [
            'CompleteName' => 'Nom complet de l’IMET espace conservé',
            'UsedName' => 'Nom de l’IMET espace conservé dans le site WDPA',
            'CompleteNameWDPA' => 'Name of the IMET conserved area in the WDPA site',
            'WDPA' => 'WDPA',
            'Type' => 'typologie',
            'Country' => 'Pays',
            'CreationYear' => 'Année de création',
            'ReferenceText' => 'Référence à la désignation du texte de publication',
            'Ownership' => 'Type de propriété de l’IMET espace conservé',
        ...
        'module_info' => '<b>Introduction à la typologie</b>: IMET identifie trois catégories d’aires conservées : (1) Aires protégées terrestres (2) Zone marine et côtière protégée (3) IMET espace conservé - Autres mesures de conservation efficaces (IMET espace conservé).<br />
          Cette IMET analyse la gestion d’une IMET espace conservé définie comme "une zone géographiquement définie autre qu’une zone protégée", qui est gouverné et géré de manière à obtenir des résultats positifs et durables à long terme pour la conservation in situ de la biodiversité, avec les fonctions et services écosystémiques associés et, le cas échéant, les aspects culturels, spirituels et socio-économiques, et d’autres valeurs pertinentes au niveau local" (CDB, 2018). Les IMET espace conservé comprennent les forêts communautaires, les peuples autochtones et les territoires et zones conservés par les communautés (ICCA), les zones marines gérées localement (LMMA),
            et d’autre typologie de aires differement conservées.<br/>Quelle est la différence entre une aire protégée et une IMET espace conservé ? (Source WDPA)
            Les aires protégées et les IMET espace conservé présentent de nombreuses similitudes, telles que l’exigence d’une limite géographiquement définie et d’un engagement à long terme.
            Mais si les aires protégées sont des lieux désignés pour obtenir des résultats positifs en matière de biodiversité,
            le terme "IMET espace conservé" s’applique aux aires désignées dans n’importe quel but, où des résultats positifs en matière de biodiversité se produisent indépendamment des objectifs de gestion initiaux.
            Dans une aire protégée, la conservation doit être l’objectif principal, ou co-primaire.
            Dans un IMET espace conservé, il peut s’agir d’un objectif secondaire ou d’un objectif non explicite.<br/>
            Les IMET espace conservé englobent également des zones qui répondent à la définition d’une aire protégée,
          dans les cas où l’autorité de gouvernance préfère que la zone soit considérée comme une IMET espace conservé.<br/>
    ...
    'Governance' => [
        ...
        'fields' => [
            ...
            'ManagementUnique' => 'Déterminer l’entité en charge de la gestion et de la gouvernance de l’IMET espace conservé',
            'ManagementName' => 'Name',
            'ManagementType' => 'Type',
        ...
        'ratingLegend' => [
            'MemberRepresentativenessLevel' => [
                '0' => 'Less than 30% of the total population of the IMET conserved area area',
                '1' => '30–50% total population of the IMET conserved area area',
                '2' => '51–75% total population of the IMET conserved area area',
                '3' => 'More than 75% of the total population of the IMET conserved area area',
            ]
        ]
    ],
    ...
    'Networks' => [
        ...
        'fields' => [
            'NetworkName' => 'Name',
            'ProtectedAreas' => 'Noms d’autres IMET espace conservé ou aires protégées au sein du réseau',
        ],
        'groups' => [
            'group0' => 'Réseau transfrontalier',
            'group1' => 'Réseau d’un paysage (terrestre et marine IMET espace conservé)',
    ...
    'Contexts' => [
        'title' => 'Références des contextes historiques, politiques, juridiques, institutionnels et socio-économiques de l’IMET espace conservé',
        'fields' => [
    ...
    'GeographicalLocation' => [
        ...
        'fields' => [
            ...
            'SourceCoords' => 'Source',
            'AdministrativeLocation' => 'Situation administrative de l’IMET espace conservé (province, région, etc.)',
        ]
    ],

    'Areas' => [
        'title' => 'Surface de l’IMET espace conservé et contexte de conservation',
        'fields' => [
            'AdministrativeArea' => 'Surface administrative',
            'WDPAArea' => 'Surface selon WDPA',
            'GISArea' => 'Surface réelle (SIG du parc ou de l’autorité responsable des IMET espace conservé) correspondant au fichier téléchargé',
            ...
            'TerrestrialArea' => 'Surface de l’IMET espace conservé terrestre, de la forêt communautaire, des ICCA, autre',
            'MarineArea' => 'Surface de l’IMET espace conservé marine et côtière, des ICCA, des LMMA, autres'
        ]
    ],
    ...
    'ManagementStaff' => [
        ...
        'module_info' => 'Nombre et catégories de membres de l’organe de gestion de l’IMET espace conservé',
    ...
    'FinancialResources' => [
        ...
        'module_info' => 'Estimation des coûts totaux de gestion de l’IMET espace conservé'
    ],
    ...
    'Equipments' => [
        ...
        'groups' => [
            ...
            'group9' => 'Liens et connexions de l’IMET espace conservé avec le monde extérieur'
        ],
        'predefined_values' => [
            ...
            'group7' => ['Routes/pistes à l’intérieur de l’IMET espace conservé', 'Chemins à l’intérieur de l’IMET espace conservé', 'Route le long de la frontière'],
            'group8' => ['Voies navigables à l’intérieur de l’IMET espace conservé'],
    ...
    'Habitats' => [
        'title' => 'Principales catégories d’habitats de l’IMET espace conservé',
        'fields' => [
            'EcosystemType' => 'Types d’habitats',
            'EcosystemDescription' => 'Description pour l\'IMET espace conservé spécifique',
            'ExploitedSpecies' => 'EXP',
            'ProtectedSpecies' => 'PRT',
            'DisappearingSpecies' => 'DSG',
            'PopulationEstimation' => 'État estimé',
    ...
    'Stakeholders' => [
        ...
        'fields' => [
            ...
            'UsesCategories' => 'Catégories d\'usages ou de gestion des éléments clés de l\'IMET espace conservé',
            'DirectUser' => 'Utilisateurs directs des éléments clés de l\'IMET espace conservé',
            'LevelEngagement' => 'Niveau d\'engagement dans la gestion des éléments clés de l\'IMET espace conservé',
            'LevelInterest' => 'Niveau d\'intérêt pour la préservation des éléments clés de l\'IMET espace conservé',
            'LevelExpertise' => 'Niveau d\'expertise dans la gestion des éléments clés de l\'IMET espace conservé (y compris les connaissances traditionnelles ou autochtones)',
        ...
        'module_info' =>
            'Identifier les acteurs impliqués dans la gestion ou l\'utilisation des ressources naturelles de l\'IMET espace conservé<br />
             ...
             <b>Catégories d\'usages ou de gestion des éléments clés de l\'IMET espace conservé</b>: différentes manières dont les parties prenantes interagissent avec
             animaux, végétaux ou habitats (Biodiversité) et bénéficier de services écosystémiques (Approvisionnement, Culturel, Régulateur,
                Accompagnement) fourni par l\'IMET espace conservé.<br />
             <b>Utilisateurs directs des éléments clés de l\'IMET espace conservé</b>: les utilisateurs directs sont ceux qui bénéficient directement des biens et services
             fourni par l\'aire conservée.<br />
             <b>Niveau d\'intérêt pour la préservation des éléments clés de l\'IMET espace conservé</b>: Degré d\'intérêt des parties prenantes pour les éléments clés de l\'IMET espace conservé
             ...
             <b>Niveau d\'expertise dans la gestion des éléments clés de l\'IMET espace conservé (y compris les connaissances traditionnelles ou autochtones)</b>: Degré à
             ...
             de l\'IMET espace conservé. L\'expertise peut provenir de connaissances traditionnelles et indigènes, de pratiques historiques, d\'observations à long terme,
        ...
        'ratingLegend' => [
            ...
            'LevelInterest' => [
                '0' => 'Pas d\'intérêt pour la conservation de l\'IMET espace conservé',
                '1' => 'Faible intérêt pour la conservation de l\'IMET espace conservé',
                '2' => 'Intérêt modéré pour la conservation de l\'IMET espace conservé',
                '3' => 'Intérêt important pour la conservation de l\'IMET espace conservé',
            ],
            'LevelExpertise' => [
    ...
    'StakeholdersObjectives' => [
        'module_info' =>
            'Établir et décrire des objectifs de conservation pour les parties prenantes impliquées dans la gestion ou l\'utilisation des
             ressources naturelles de l\'IMET espace conservé. Les objectifs inscrits ci-dessous serviront à améliorer la gestion, et plus particulièrement
             pour la planification, la mobilisation des ressources (intrants), les phases de processus et pour le suivi des activités de gestion de l\'IMET espace conservé.'
    ],
    ...
    'AnalysisStakeholderDirectUsers' => [
        ...
        'module_info' =>
            ...
            '<b>Threads</b>: Human activities or processes that have impacted, are impacting or may impact the IMET conserved area’s key element being assessed.</br >',
        'ratingLegend' => [
            'Dependence' => [
                '0' => 'Très faible',
                '1' => 'Faible',
    ...
    'AnalysisStakeholderIndirectUsers' => [
        ...
        'fields' => [
            ...
            'Status' => 'Statut des éléments clés de l\'IMET espace conservé',
            'Trend' => 'Tendance des éléments clés de l\'IMET espace conservé',
            'Threats' => 'Menaces',
            'Comments' => 'Note',
        ],
        'module_info' =>
            ...
            '<b>Statut des éléments clés de l\'IMET espace conservé</b>: L\'état des éléments clés indique l\'état de la fourniture des services
                ...
                de disparaître dans la zone de l\'IMET espace conservé. Un très bon état indique que l\'élément clé est de bonne qualité ou
                ...
                peuvent affecter l\'état des éléments clés de l\'IMET espace conservé.</br >' .
            '<b>Tendance des éléments clés de l\'IMET espace conservé</b>: Les tendances actuelles des éléments clés indiquent le changement
            ...
            '<b>Menaces</b>: Activités ou processus humains qui ont impacté, impactent ou peuvent impacter l’élément clé
                de l\'IMET espace conservé évalué.</br >',
        'ratingLegend' => [
            'Support' => [
    ...
    'AnalysisStakeholdersObjectives' => [
        'module_info' =>
            'Établir et décrire les objectifs de conservation pour les parties prenantes analyse des éléments clés de l\'IMET espace conservé.
            Les objectifs inscrits ci-dessous seront utilisés pour améliorer la gestion, et plus spécifiquement pour la planification,
            la mobilisation des ressources (intrants), les phases de processus et pour le suivi des activités de gestion de l\'IMET espace conservé.'
    ],
