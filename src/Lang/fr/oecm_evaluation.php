...
return [
    ...
    'Designation' => [
        ...
        'module_info_EvaluationQuestion' => [
            'Evaluate the Intégration of values and importance of designations (national designation and international designations, e.g., World Heritage site or Ramsar site) for the management of the IMET conserved area'
        ],
    ...
    'KeyElements' => [
        'title' => 'Eléments clés de l’IMET espace conservé',
        'fields' => [
        ...
        'module_info_EvaluationQuestion' => [
            'L\'IMET espace conservé a-t-elle priorisé les éléments clés dans sa gestion ? L\'évaluation doit évaluer la nécessité de
             prioriser les éléments clés dans la gestion de l\'IMET espace conservé. L\'évaluation utilise une liste classée basée sur les analyses de SA1, SA2 et C3.1.1'
        ],
        'module_info_Rating' => [
            'Évaluer la nécessité de prioriser les éléments clés dans la gestion de l\'IMET espace conservé'
        ],
    ...
    'SupportsAndConstraints' => [
        ...
        'module_info_EvaluationQuestion' => [
            'Les contraintes/conflits ou les soutiens/conformités des parties prenantes peuvent être mesurés par l’intensité de leurs contraintes/conflits ou de leurs soutiens/conformités à l’égard de l’IMET espace conservé'
        ],
        'module_info_Rating' => [
            'Évaluer les contraintes/conflits ou les facteurs de soutien/conformité les plus importants de l’environnement politique, institutionnel et social dans la gestion de l’IMET espace conservé'
        ]
    ],
    ...
    'SupportsAndConstraintsIntegration' => [
        ...
        'module_info_EvaluationQuestion' => [
            'L\'évaluation évalue la nécessité de prioriser la minimisation des contraintes de gestion ou la maximisation
             de l\'accompagnement des acteurs dans la gestion de l\'IMET espace conservé. L\'évaluation utilise la liste de classement basée sur l\'intégration
             ...
             dans la gestion des valeurs IMET espace conservé (SA1 du contexte d\'intervention).'
        ],
        'module_info_Rating' => [
    ...
    'ThreatsBiodiversity' => [
        'title' => 'Analyse des menaces pesant sur les éléments clés de la biodiversité de l’IMET espace conservé',
        'fields' => [
            'Criteria' => 'Critère',
    ...
    'Threats' => [
        'title' => 'Analyse des menaces IMET espace conservé',
        'fields' => [
            'Value' => 'Valeurs',
            'Impact' => 'Impact/ Gravité',
            'Extension' => 'Échelle/ Étendue',
        ...
        'module_info_EvaluationQuestion' => [
            'L’IMET espace conservé a-t-elle clairement identifié les menaces susceptibles d’affecter la biodiversité, le patrimoine culturel ou les services écosystémiques de l’aire ?'
        ],
        'module_info_Rating' => [
            'Évaluer le niveau des menaces les plus importantes dans la gestion de l’IMET espace conservé sur la base de l’analyse du calculateur de menaces au point SA 2 du contexte d’intervention et automatiquement rapporté ci-dessous. Évaluation des menaces (rapportée automatiquement à partir du SA 2) Priorité dans la gestion Commentaires/explications'
        ],
        'num_stakeholders' => 'Indiqué par :num_dir partie(s) prenante(s) direct et par :num_ind partie(s) prenante(s) indirect',
    ],
    ...
    'ThreatsIntegration' => [
        ...
        'module_info_EvaluationQuestion' => [
            'L\'évaluation évalue la nécessité de hiérarchiser les menaces afin de minimiser leurs effets et leur impact sur l\'IMET espace conservé
             gestion. L\'évaluation utilise la liste de classement basée sur l\'analyse des menaces in C3.1.1 et C3.1.2'
        ],
        'module_info_Rating' => [
            'Évaluer l\'intégration actuelle des menaces dans la gestion de l\'IMET espace conservé'
        ],
    ...
    'RegulationsAdequacy' => [
        ...
        'predefined_values' => [
            ...
            'Clarté de la démarcation juridique de l’IMET espace conservé (par exemple, frontières naturelles telles que les rivières, frontières non naturelles, droits coutumiers, enclaves)',
            'Règles internes pour la gestion de l’IMET espace conservé',
            'Ratification et application des conventions internationales (CITES, CDB, Nagoya, CMS, patrimoine mondial, RAMSAR, etc.)',
            'Lois locales sur l’IMET espace conservé et la conservation (fermeture spatiale et temporelle de l’exploitation, de la chasse, de la pêche ; quotas, limites sur le contrôle du nombre et de la taille des navires ; interdiction des méthodes ou des engins d’exploitation, de chasse et de pêche, etc.)',
            'Lois nationales sur l’environnement (gestion des ressources naturelles, conservation, IMET espace conservé))',
            'Autres lois nationales (droits fonciers et de propriété, impôts, droit des affaires, etc.)'
        ],
        'ratingLegend' => [
            'EvaluationScore' => [
                'N/A' => 'cet élément n’est pas lié à la gestion de l’IMET espace conservé',
                '0' => 'Inadéquat',
                '1' => 'Plutôt inadéquat',
                '2' => 'Adéquat',
        ...
        'module_info_EvaluationQuestion' => [
            'Les dispositions légales et réglementaires actuelles sont-elles adaptées aux activités de conservation et de gestion des ressources naturelles dans l’IMET espace conservé ?',
            '<i>Une législation et des dispositions réglementaires adéquates constituent la base d’une gouvernance et d’un cadre de gestion efficaces et solides pour l’IMET espace conservé et, plus important encore, pour assurer sa viabilité à long terme pour les générations actuelles et futures.</i>'
        ],
        'module_info_Rating' => [
            'Identifier et évaluer l’adéquation des dispositions légales et réglementaires actuelles en matière de conservation et de gestion des ressources naturelles dans l’IMET espace conservé'
        ]
    ],

    'DesignAdequacy' => [
        'title' => 'Conception, taille et forme de l’IMET espace conservé',
        'fields' => [
        ...
        'predefined_values' => [
            'Taille (surface)',
            'Configuration ou forme de l’IMET espace conservé',
            'Intégration des aires frontalières (en dehors de l’IMET espace conservé qui ont des règles spéciales sur l’utilisation des ressources pour l’intégrité des captages d’eau, des corridors pour la faune, des activités d’exploitation, de chasse et de pêche, etc.)'
        ],
        'ratingLegend' => [
            'EvaluationScore' => [
                'N/A' => 'cet élément n’est pas lié à la gestion de l’IMET espace conservé',
        ...
        'module_info_EvaluationQuestion' => [
            'La conception, la taille et la forme de l’IMET espace conservé sont-ils adaptés à la gestion durable et à la gouvernance de ses éléments clés ?',
        ...
        'module_info_Rating' => [
            'Évaluer si la conception et la disposition de l’IMET espace conservé (sur la base de l’analyse du contexte du point d’intervention CTX2) sont adéquates pour garantir une bonne gestion de ses éléments clés'
        ]
    ],

    'BoundaryLevel' => [
        'title' => 'Démarcation de l’IMET espace conservé',
        'fields' => [
        ...
        'module_info_EvaluationQuestion' => [
            'Les limites de l’IMET espace conservé sont-elles marquées et adéquates ?',
            'La délimitation des IMET espace conservé est utile d’un point de vue juridique, car elle permet de définir exactement où les contrôles spécifiques à l’IMET espace conservé peuvent être mis en œuvre (par exemple, la surveillance et les sanctions peuvent être appliquées en cas d’utilisation non durable des éléments clés)'
        ],
        'module_info_Rating' => [
            'Évaluer  <ol type="A"><li>le degré de marquage des limites de l’aire IMET espace conservé</li><li>l’adéquation de la démarcation des limites pour la gestion de l’IMET espace conservé</li></ol>'
        ]
    ],
    ...
    'ManagementPlan' => [
        ...
        'module_info_EvaluationQuestion' => [
            'Existe-t-il un plan de gestion ? Si oui, est-il adéquat et pratique à mettre en œuvre pour l’IMET espace conservé ?',
    ...
    'WorkPlan' => [
        ...
        'module_info_EvaluationQuestion' => [
            'Existe-t-il un plan de travail ? Si oui, est-il adéquat et pratique à mettre en œuvre pour l’IMET espace conservé ?',
            'Un plan de travail décrit les activités spécifiques à mettre en œuvre pour suivre les progrès accomplis dans la réalisation des résultats de l’IMET espace conservé. Il fournit les informations nécessaires pour mesurer le succès de l’IMET espace conservé dans ses efforts de conservation (effets et impacts).'
        ]
    ],

    'Objectives' => [
        'title' => 'Objectifs de l’IMET espace conservé',
        'fields' => [
            'Objective' => 'Objectif',
        ...
        'module_info_EvaluationQuestion' => [
            'Les objectifs fixés pour l’IMET espace conservé sont-ils adéquats ?',
            'Les buts et objectifs de l’IMET espace conservé doivent être clairement compris. Ils doivent être bien définis et formulés de manière à faciliter le suivi, mais aussi se rapporter aux valeurs clés de l’IMET espace conservé (c’est-à-dire les espèces ou les écosystèmes importants) ou aux principaux domaines d’activité de la gestion (par exemple, le tourisme, l’éducation)'
        ],
        'module_info_Rating' => [
            'Évaluer la pertinence des objectifs du plan de gestion pour les éléments clés de l\'IMET espace conservé, en fonction des objectifs existants du plan de gestion et du contexte de gestion'
        ],
    ...
    'ObjectivesContext' => [
        'module_info' =>
            'Établir et décrire les objectifs de conservation pour le contexte de gestion de l\'IMET espace conservé. Les objectifs listés ci-dessous
            ...
            phases du processus et pour le suivi des activités de gestion de l\'IMET espace conservé.'
    ],

    'ObjectivesPlanification' => [
        'module_info' => 'Établir et décrire les objectifs de conservation pour la planification de l’IMET espace conservé<br />Les objectifs énumérés ci-dessous seront utilisés pour améliorer la gestion, et plus spécifiquement pour la planification, la mobilisation des ressources (intrants), les phases du processus, et pour le suivi des activités de gestion de l’IMET espace conservé'
    ],
    ...
    'InformationAvailability' => [
        ...
        'module_info_EvaluationQuestion' => [
            'Disposez-vous d\'informations suffisantes et pertinentes pour appuyer le processus décisionnel de l’IMET espace conservé ?',
            'Une gestion efficace de l’IMET espace conservé nécessite des connaissances et des informations suffisantes pour éclairer la prise de décision. Sans information, une bonne gestion est hautement improbable'
        ],
        'module_info_Rating' => [
            'Évaluer la disponibilité des informations nécessaires pour soutenir la gestion des éléments clés de l\'IMET espace conservé,
    ...
    'CapacityAdequacy' => [
        ...
        'module_info_EvaluationQuestion' => [
            'L\'entité ou les entités en charge de la gestion et de la gouvernance ont-elles une capacité suffisante pour gérer et gouverner l\'IMET espace conservé'
        ],
        'module_info_Rating' => [
            'Des ressources humaines qualifiées, compétentes, engagées et adéquates sont essentielles au succès des IMET espace conservé'
        ]
    ],
    ...
    'BudgetAdequacy' => [
        ...
        'module_info_EvaluationQuestion' => [
            'Le budget actuel est-il suffisant pour une gestion appropriée de l’IMET espace conservé ?',
            'Les IMET espace conservé préparent leur budget annuel de fonctionnement chaque année ou pour plusieurs années. Des documents clés relatifs à la planification financière et au budget sont nécessaires pour améliorer l’efficience et l’efficacité opérationnelles'
        ],
        'module_info_Rating' => [
            'Évaluer l’adéquation du financement de l’IMET espace conservé pour l’année en cours par rapport aux besoins de conservation (sur la base de l’analyse du contexte d’intervention, point CTX 3.2)'
        ]
    ],
    ...
    'BudgetSecurization' => [
        ...
        'ratingLegend' => [
            'Percentage' => [
                '0' => 'Les besoins financiers de base pour la gestion de l’IMET espace conservé ne sont pas assurés (0-20% des besoins assurés)',
                '1' => 'Les besoins financiers de base pour la gestion de l’IMET espace conservé sont très faiblement assurés (21-40% des besoins assurés)',
                '2' => 'Les besoins financiers de base pour la gestion de l’IMET espace conservé sont faiblement assurés (41-60% des besoins assurés)',
                '3' => 'Les besoins financiers de base pour la gestion de l’IMET espace conservé sont partiellement assurés (61-75% des besoins assurés)',
                '4' => 'Les besoins financiers de base pour la gestion de l’IMET espace conservé sont relativement bien assurés (76-90% des besoins assurés)',
                '5' => 'Les besoins financiers de base pour la gestion de l’IMET espace conservé sont assurés (> 90% des besoins assurés)',
            ],
            'EvaluationScore' => [
                '0' => 'Les besoins financiers de base pour la gestion de l’IMET espace conservé ne sont assurés que pour 1 an (année en cours)',
                '1' => 'Les besoins financiers de base pour la gestion de l’IMET espace conservé sont assurés pour 2 ans (année en cours +1 an)',
                '2' => 'Les besoins financiers de base pour la gestion de l’IMET espace conservé sont assurés pour 3 ans (année en cours +2 ans)',
                '3' => 'Les besoins financiers de base pour la gestion de l’IMET espace conservé sont assurés pour 4 ans et plus. (année en cours +3 ans et plus)'
            ]
        ],
        'module_info_EvaluationQuestion' => [
            'Quelle part du budget requis est assurée, et pour combien de temps, pour couvrir les besoins de base en matière de gestion de l’IMET espace conservé ?',
            'Un budget sûr et fiable est essentiel pour la planification et la gestion de l’IMET espace conservé, pour les activités à grande échelle et à long terme'
        ],
        'module_info_Rating' => [
            'Évaluer : A) la sécurité du financement et B) la période de sécurité du financement pour les années à venir par rapport aux exigences de conservation dans l’IMET espace conservé'
        ]
    ],
    ...
    'ManagementEquipmentAdequacy' => [
        ...
        'fields' => [
            ...
            'PresentNeeds' => 'B) Besoins actuels en matière de disponibilité pour la gestion de l’IMET espace conservé',
            'Comments' => 'Commentaires/Explication',
        ],
        ...
        'module_info_EvaluationQuestion' => [
            'L’infrastructure, l’équipement et les installations de l’IMET espace conservé sont-ils adaptés aux exigences de la gestion ? L’infrastructure, l’équipement et les installations sont importants pour garantir et améliorer l’efficacité opérationnelle de l’IMET espace conservé'
        ],
        'module_info_Rating' => [
            'Évaluer : A) l’adéquation des infrastructures, des équipements et des installations (résultats calculés automatiquement sur la base de l’analyse du contexte d’intervention, point CTX 3.3), B) les besoins actuels en matière de disponibilité d’infrastructures, d’équipements et d’installations spécifiques pour l’IMET espace conservé',
        ]
    ],

    'ObjectivesIntrants' => [
        'module_info' => 'Établir et décrire les objectifs de conservation pour les intrants de l’IMET espace conservé<br />Les objectifs énumérés ci-dessous seront utilisés pour améliorer la gestion, et plus spécifiquement pour la planification, la mobilisation des ressources (intrants), les phases du processus et le suivi des activités de gestion de l’IMET espace conservé'
    ],

    'ObjectivesProcessus' => [
        'module_info' => 'Établir et décrire les objectifs de conservation liés au processus de mise en œuvre de l’IMET espace conservé Les objectifs saisis ci-dessous seront utilisés pour améliorer la gestion, et plus particulièrement pour la planification, la mobilisation des ressources (intrants), les phases du processus, et pour le suivi des activités de gestion de l’IMET espace conservé'
    ],
    ...
    'StaffCompetence' => [
        ...
        'fields' => [
            ...
            'Weight' => 'Implication',
            'Adequacy' => 'Adéquation des activités de renforcement des capacités pour l’entité de gestion de l’IMET espace conservé',
            'Comments' => 'Commentaires/Explication',
        ],
        'groups' => [
            'group0' => 'Composition et personnel ou membres de l’IMET espace conservé',
            'group1' => 'Parties prenantes impliquées dans la gestion et l’utilisation des ressources naturelles de l’IMET espace conservé'
        ],
        'ratingLegend' => [
            'Adequacy' => [
        ...
        'module_info_EvaluationQuestion' => [
            'L\'entité spécifique de gestion et de gouvernance de l\'IMET espace conservé ou la combinaison d\'entités mettent-elles en œuvre des
             programme(s) de formation et de renforcement des capacités répondant aux besoins de leurs membres pour atteindre les objectifs de l\'IMET espace conservé?',
            'Une main-d\'œuvre qualifiée, compétente et engagée est essentielle au succès des IMET espace conservé'
        ],
        'module_info_Rating' => [
            'Évaluer l\'adéquation des activités de renforcement des capacités pour l\'entité spécifique de gestion et de gouvernance de l\'IMET espace conservé
    ...
    'HRmanagementPolitics' => [
        ...
        'module_info_EvaluationQuestion' => [
            'L’entité spécifique ou la combinaison d’entités de l’IMET espace conservé chargée de la gestion et de la gouvernance a-t-elle adopté des politiques de gestion adéquates pour motiver et retenir ses ressources humaines ?'
        ],
        'module_info_Rating' => [
        ...
        'module_info' => 'Dispositions des politiques de gestion des ressources humaines de l’entité ou de la combinaison d’entités spécifiques de l’IMET espace conservé en matière de gestion et de gouvernance (identifiées dans SA 1 ou CTX 3.1.1) :',
    ],
    ...
    'AdministrativeManagement' => [
        ...
        'module_info_EvaluationQuestion' => [
            'Le budget et les ressources financières sont-ils bien gérés pour répondre aux besoins essentiels et prioritaires de l’IMET espace conservé en matière de gestion ?',
            'La gestion budgétaire et financière d’une IMET espace conservé doit être solide pour permettre une budgétisation et une allocation des ressources adéquates. Une gestion budgétaire et financière efficace n’est possible que si l’on dispose d’un plan de gestion et de travail solide assorti d’objectifs clairs'
        ],
        'module_info_Rating' => [
    ...
    'EquipmentMaintenance' => [
        ...
        'module_info_EvaluationQuestion' => [
            'L’infrastructure, l’équipement et les installations de l’IMET espace conservé sont-ils correctement entretenus ?',
            'Une infrastructure, un équipement et des installations mal entretenus s’usent non seulement plus rapidement, mais gaspillent également les ressources et réduisent fondamentalement la capacité de l’IMET espace conservé à atteindre ses objectifs'
        ],
        'module_info_Rating' => [
            'Évaluer le niveau de maintenance des infrastructures, des équipements et des installations par rapport aux exigences de gestion de l’IMET espace conservé (sur la base de l’analyse du contexte d’intervention, point CTX 3.3)'
        ]
    ],
    ...
    'ManagementActivities' => [
        ...
        'groups' => [
            'group0' => 'Éléments clés de l’IMET espace conservé'
        ],
        'ratingLegend' => [
            'EvaluationScore' => [
                'N/A' => 'cet élément n’est pas lié à la gestion de l’IMET espace conservé',
        ...
        'module_info_EvaluationQuestion' => [
            'Existe-t-il des mesures de gestion spécifiques pour les éléments clés de l’IMET espace conservé ?',
            'Pour garantir une gestion durable des éléments clés de l’IMET espace conservé, les parties prenantes/associations de gestion doivent évaluer les pratiques et les actions qui peuvent inclure la conservation/restauration des espèces animales (par exemple, les abeilles) et végétales (par exemple, la pharmacopée), la gestion des incendies, les travaux de re-végétalisation, le contrôle des espèces envahissantes, la gestion des ressources culturelles, l’endiguement des menaces, etc.'
        ],
        'module_info_Rating' => [
    ...
    'LawEnforcementImplementation' => [
        ...
        'predefined_values' => [
            ...
            'group1' => [
                ...
                'Collaboration avec des ONG spécialisées dans les lois terrestres et marines, l’application, etc. (droits, règles, etc.) sur la gestion durable des éléments clés de l’IMET espace conservé'
            ]
        ],
        'ratingLegend' => [
            'Adequacy' => [
        ...
        'module_info_EvaluationQuestion' => [
            'Dans quelle mesure le contrôle et les actions contre les activités illégales visant à garantir la durabilité de la gestion des éléments clés de l’IMET espace conservé sont-ils adéquats ?',
            'Le contrôle (activités d’observation et collecte de données) est une activité essentielle pour faire respecter les règles juridiques, traditionnelles et spécifiques existantes afin de garantir la gestion à long terme des éléments clés de l’IMET espace conservé'
        ],
        'module_info_Rating' => [
            ...
            'Évaluer les mesures prises pour lutter contre les activités illégales ou pour résoudre les questions litigieuses dans le cadre de la gestion durable des éléments clés de l’IMET espace conservé'
        ]
    ],
    ...
    'StakeholderCooperation' => [
        ...
        'module_info_EvaluationQuestion' => [
            'Existe-t-il des mesures pour améliorer la coopération des parties prenantes dans la gouvernance et la gestion de l’IMET espace conservé ?',
            'L’évaluation vise à déterminer le degré de coopération et de participation effective des parties prenantes qui contribue à la légitimité et à l’efficacité de la gouvernance de l’IMET espace conservé'
          ],
          'module_info_Rating' => [
            'Évaluer le niveau de l’implication, de la participation, de l’engagement et des connaissances et perspectives locales des parties prenantes dans la gouvernance et la gestion de l’IMET espace conservé'
          ]
      ],
    ...
    'AssistanceActivities' => [
        ...
        'predefined_values' => [
            'group0' => [
                ...
                'Soutien à l’emploi des ressources humaines locales dans l’IMET espace conservé, dans le tourisme, etc.',
                'Soutenir les prestataires de services locaux',
                'Fourniture de ressources naturelles en cas de besoin (par exemple, eau, fibres, etc. provenant des IMET espace conservé pendant les crises ou contribution matérielle pour les bâtiments sociaux tels que l’hôpital, l’école)',
            ...
            'group1' => [
                'Minimisation des conflits et renforcement de la gestion et de l’utilisation durables des éléments clés de l’IMET espace conservé (approvisionnement et culture)',
                ...
                'Fourniture de services culturels (physiques - intellectuels - emblématiques - spirituels - interaction avec les services de l’IMET espace conservé)',
        ...
        'module_info_EvaluationQuestion' => [
            'L’IMET espace conservé mène-t-elle des activités/programmes destinés à fournir des avantages/une assistance appropriés aux communautés ?',
        ...
        'module_info_Rating' => [
            'Évaluer l’adéquation des activités/programmes mis en œuvre par l’IMET espace conservé pour fournir des avantages/une assistance aux parties prenantes'
        ],
    ],
    ...
    'EnvironmentalEducation' => [
        ...
        'predefined_values' => [
            'Programmes de conservation des parties prenantes de l’IMET espace conservé',
            'Programmes de sensibilisation des acteurs de l’IMET espace conservé',
            'Programmes de sensibilisation des parties prenantes autres que celles de l’IMET espace conservé',
            'Programme d’éducation à l’environnement dans les écoles du paysage de l’IMET espace conservé',
            'Radio - Programmes télévisés sur l’IMET espace conservé (par exemple, sur les stations de radio communautaires)',
            'Conférences et débats sur l’IMET espace conservé',
            'Visites guidées pour les acteurs de l’IMET espace conservé',
        ...
        'module_info_EvaluationQuestion' => [
            'L’IMET espace conservé mène-t-elle des activités/programmes d’éducation environnementale et de sensibilisation du public spécifiquement liés aux besoins et aux objectifs de conservation/gestion des éléments clés ?',
            'L’éducation environnementale peut aider les individus à trouver un équilibre entre leurs propres besoins vitaux et les besoins de l’environnement naturel qui fournit des services (approvisionnement, régulation, culture et soutien) aux parties prenantes à l’intérieur et à l’extérieur, près et loin de l’IMET espace conservé (en tenant compte de la désignation spécifique de l’IMET espace conservé). Cet objectif pourrait être atteint en renforçant la sensibilisation et en changeant effectivement le point de vue des parties prenantes sur l’IMET espace conservé'
        ],
        'module_info_Rating' => [
            'Évaluer l’adéquation des activités/programmesd’éducation à l’environnement et de sensibilisation du public soutenus par l’IMET espace conservé'
        ]
    ],
    ...
    'VisitorsManagement' => [
        ...
        'predefined_values' => [
            ...
            'Avantages économiques pour la gestion et la gouvernance des IMET espace conservé',
            'Gestion de l’hébergement, de la restauration et des activités de loisirs (également pour les personnes handicapées)',
            'Les guides touristiques de l’IMET espace conservé',
        ...
        'module_info_EvaluationQuestion' => [
            'L’IMET espace conservé gère-t-elle (conçoit-elle, met-elle en place, entretient-elle et améliore-t-elle) les installations, les services et l’impact du tourisme environnemental sur les visiteurs ?',
            'Le tourisme se produit dans des contextes historiques, culturels et géographiques uniques, impliquant de multiples valeurs et acteurs de l’IMET espace conservé. Une gestion efficace du tourisme dans l’IMET espace conservé exige une appréciation et une compréhension des contextes de durabilité environnementale, sociale et économique, ainsi qu’une gestion compatible des installations et des services destinés aux visiteurs'
        ],
        'module_info_Rating' => [
            'Évaluer l’adéquation de la gestion des installations et des services destinés aux visiteurs, ainsi que l’impact sur le tourisme environnemental et culturel de l’IMET espace conservé'
        ]
    ],
    ...
    'NaturalResourcesMonitoring' => [
        ...
        'predefined_values' => [
            'Utilisation des données de suivi pour induire des changements dans la gestion et la gouvernance de l’IMET espace conservé',
            'Suivi des éléments clés',
            'Surveillance des menaces pesant sur l’IMET espace conservé',
        ...
        'module_info_EvaluationQuestion' => [
            'Les systèmes de suivi et de recherche permettent-ils de suivre efficacement les éléments clés de l’IMET espace conservé ?',
            'Pour anticiper les problèmes potentiels et planifier les meilleures interventions, il est indispensable de bien comprendre les tendances des éléments clés de l’environnement et des services de l’IMET espace conservé tels que la biodiversité, l’approvisionnement (eau, nourriture, etc.), la qualité des forêts, les menaces, etc.'
        ],
        'module_info_Rating' => [
            'Évaluer l’adéquation des systèmes de suivi et de recherche mis en place pour les éléments clés de l’IMET espace conservé'
        ]
    ],
    ...
    'WorkProgramImplementation' => [
        ...
        'module_info_EvaluationQuestion' => [
            'Dans quelle mesure l’IMET espace conservé a-t-elle mis en œuvre les principales activités du plan de travail/action ?',
            'La mise en œuvre est la réalisation ou l’exécution du plan de travail/action annuel ou pluriannuel concernant les activités de l’IMET espace conservé'
        ],
        'module_info_Rating' => [
    ...
    'ManagementGovernance' => [
        ...
        'module_info_EvaluationQuestion' => [
            'Quelle est l’étendue actuelle du contrôle de la gestion et de la gouvernance des éléments clés de l’IMET espace conservé ?',
            'La capacité à assurer le contrôle et la collecte d’informations sur les éléments clés prioritaires de la gestion et de la gouvernance de l’IMET espace conservé permet de prévenir ou de minimiser les activités illégales ou les questions litigieuses'
        ],
        'module_info_Rating' => [
            'Évaluer le contrôle des éléments clés considérés comme prioritaires dans la gestion et la gouvernance de l’IMET espace conservé'
        ]
    ],

    'AchievedObjectives' => [
        'title' => 'Atteinte des objectifs à long terme de la gestion et de la gouvernance de l’IMET espace conservé',
        'fields' => [
        ...
        'module_info_EvaluationQuestion' => [
            'Dans quelle mesure l’IMET espace conservé a-t-elle atteint les principaux objectifs de son plan de gestion et de gouvernance ?',
            ...
            'Les buts et objectifs d’une IMET espace conservé doivent être clairement compris si l’on veut que la gestion soit réussie sur la base de résultats mesurables'
        ],
        'module_info_Rating' => [
            'Évaluer le niveau de réalisation des principaux objectifs à long terme liés aux éléments clés de l’IMET espace conservé'
        ]
    ],
    ...
    'KeyElementsImpact' => [
        ...
        'module_info_EvaluationQuestion' => [
            'La gestion et la gouvernance exercent-elles des effets positifs ou négatifs sur les éléments clés de conservation de l\'IMET espace conservé ?',
            'L\'un des principaux objectifs de l\'IMET espace conservé est de fournir des résultats positifs et durables pour la conservation in situ
        ...
        'module_info_Rating' => [
            'Assurer une double analyse collaborative entre les utilisateurs directs et indirects, les parties prenantes ou leurs représentants sur A) l’état et B) les tendances des éléments clés de la conservation de l’IMET espace conservé'
        ],
        'ratingLegend' => [
            'StatusSH' => [
                '-2' => 'En diminution',
    ...
    'LifeQualityImpact' => [
        ...
        'predefined_values' => [
            'group0' => [
                ...
                'Emploi des ressources humaines locales dans l’IMET espace conservé, dans le tourisme, etc.',
                'Ressources naturelles en cas de besoin (par exemple, eau, fibres, etc. provenant des IMET espace conservé pendant les crises ou contribution matérielle pour les bâtiments sociaux tels que l’hôpital, l’école)',
            ...
            'group1' => [
                'Conflits et renforcement de la gestion et de l’utilisation durables des éléments clés de l’IMET espace conservé (approvisionnement et culture)',
                'Éducation, infrastructures de santé (bâtiments, eau potable)',
                'Services éducatifs (enseignement), services de santé (soins de santé)',
                'Services culturels (physiques - intellectuels - emblématiques - spirituels - interaction des services de l’IMET espace conservé),',
        ...
        'module_info_EvaluationQuestion' => [
            'La gestion et la gouvernance de l’IMET espace conservé ont-elles des effets positifs ou négatifs sur la qualité de vie des parties prenantes ?',
            'La gestion et la gouvernance de l’IMET espace conservé doivent être très attentives aux effets sur la qualité de vie des acteurs locaux. La disponibilité des ressources essentielles peut affecter la qualité de la vie en ayant des répercussions sur la consommation, le revenu et la richesse (niveau de vie matériel) et sur la qualité de vie, la santé et les relations sociales et culturelles (niveau de vie immatériel)'
        ],
        'module_info_Rating' => [
            'Évaluer les effets de la gestion et de la gouvernance de l’IMET espace conservé sur les parties prenantes'
        ]
    ],
    ...
    'EmpowermentGovernance' => [
        ...
        'predefined_values' => [
            'group0' => [
                'Représentation : mécanismes existants qui garantiront la représentation légitime des parties prenantes dans le processus décisionnel de l’IMET espace conservé',
            ...
            'group1' => [
                ...
                'L’équité dans les coûts et les bénéfices associés à la conservation : maximiser les bénéfices écologiques, sociaux, économiques et culturels des IMET espace conservé sans encourir de coûts inutiles ni causer de dommages aux communautés locales',
                'Efficacité de la gestion : application de la gouvernance existante des services écosystémiques efficace et efficiente dans la fourniture des avantages écologiques, sociaux, économiques et culturels de l’IMET espace conservé'
            ],
            'group2' => [
                ...
                'Respect des valeurs : soutenir l’amélioration de toutes les valeurs écologiques, d’approvisionnement, de contrôle et culturelles de l’IMET espace conservé dans l’intérêt des communautés'
            ]
        ],
        ...
        'module_info_EvaluationQuestion' => [
            'La direction de l’IMET espace conservé encourage-t-elle activement les initiatives d’autonomisation des parties prenantes afin de garantir une plus grande implication des parties prenantes pour une mise en œuvre plus efficace et plus percutante des mesures de conservation ?',
            'L’autonomisation des parties prenantes est la pierre angulaire de la gestion et de la gouvernance d’une IMET espace conservé, jouant un rôle essentiel dans la promotion d’un engagement significatif, d’une responsabilité partagée et d’une prise de décision collaborative entre les diverses parties prenantes. En responsabilisant les parties prenantes, l’IMET espace conservé cherche à exploiter leurs connaissances, leurs perspectives et leurs contributions collectives, ce qui conduit en fin de compte à une mise en œuvre plus complète, plus durable et plus efficace des mesures de conservation',
        ],
        'module_info_Rating' => [
