...
return [
    ...
    'GeneralInfo' => [
        ...
        'module_info' => '<b>Introduction à la typologie</b>: Introduction à la typologie: IMET identifie trois catégories
            d’aires protégées: (1) Terrestres (2) Marines et côtières (3) IMET espace conservé. Dans la section Gouvernance (CTX 1.2), vous pouvez affiner la typologie de gestion et de gouvernance
