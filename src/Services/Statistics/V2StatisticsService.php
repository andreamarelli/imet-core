...
class V2StatisticsService extends StatisticsService
{
    ...
    public static function scores_process($imet): array
    {
        ...
        $scores = [
            ...
            'pr5' => static::score_table($imet_id, Evaluation\AdministrativeManagement::class, 'EvaluationScore', 'get_imet_evaluation_stats_table_all_4'),
            ...
            'pr9' => static::score_group($imet_id, Evaluation\IntelligenceImplementation::class, 'Adequacy', 'group_key', 'get_imet_evaluation_stats_group_all_fix'),
            'pr10' => static::score_pr10($imet_id),
            'pr11' => static::score_group($imet_id, Evaluation\AssistanceActivities::class, 'EvaluationScore', 'group_key', 'get_imet_evaluation_stats_group_all_fix'),
