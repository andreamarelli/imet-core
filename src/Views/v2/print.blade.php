...
@section('body')
    ...
    <div id="print_body" class="print_body">
        ...
        <a href="{{ action([\AndreaMarelli\ImetCore\Controllers\Imet\Controller::class, 'index']) }}" class="btn-nav rounded" style="margin-bottom: 20px;">{{ ucfirst(trans('common.go_back')) }}</a>
