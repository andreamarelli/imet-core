...
<ul class="text-2xs" style="margin-top: 10px; padding-inline-start: 20px;">
    <li>
        <b>@lang('imet-core::form/imet/v2/context.CreateNonWdpa.allowed_international')</b>:
        <ul>
    ...
    <li>
        <b>@lang('imet-core::form/imet/v2/context.CreateNonWdpa.allowed_regional')</b>:
        <ul>
    ...
    <li>
        <b>@lang('imet-core::form/imet/v2/context.CreateNonWdpa.allowed_national')</b>
    </li>
</ul>
