    ...
    <script>
        new Vue({
            ...
            data: {
                ...
                dopa_indicators: {
                    forest_cover: {
                        title_table: "@lang('imet-core::form/v2/report.forest_cover')",
