                ...
                <tr class="module-table-item" v-for="element in key_elements_importance">
                    <td style="text-align: left;">
                        ...
                        <div class="text-left text-xs" style="padding: 4px 4px 0 4px;">
                            <div v-html="importance_sum_label(element)"></div>
                            <div v-html="num_stakeholder_label(element)"></div>
                        </div>
                    </td>
    ...
    <script>
        ...
        let module_analysis_stakeholder_summary = new Vue({
            ...
            methods: {
                ...
                importance_sum_label(element){
                    return Locale.getLabel('imet-core::oecm_evaluation.KeyElements.key_elements_importance_sum', {
                        'imp_dir': '<b>' + element['importance_direct'] + '</b>',
                        'imp_ind': '<b>' + element['importance_indirect'] + '</b>',
                    })
                },

                num_stakeholder_label(element){
