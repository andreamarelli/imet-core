    ...
    <div id="imet_report">
                ...
                <div class="module-body">
                    <div style="display: flex;">
                        <div>
                            ...
                            <div>
                                <div class="strong">@lang('imet-core::oecm_context.CreateNonWdpa.fields.origin_name'):
                                </div>
                                {{ $general_info['origin_name'] ?? '-' }}
                            </div>
                            <div>
                                <div class="strong">@lang('met-core::oecm_context.CreateNonWdpa.fields.designation'):
                                </div>
                            ...
                            <div>
                                <div
                                    class="strong">@lang('imet-core::oecm_context.CreateNonWdpa.fields.designation_type')
                                    :
                                </div>
                            ...
                            <div>
                                <div
                                    class="strong">@lang('imet-core::oecm_context.CreateNonWdpa.fields.status_year')</div>
        ...
        <div class="module-container">
            ...
            <div class="module-body">
                ...
                <h3>4. @lang('imet-core::oecm_report.stakeholder_users_managing_oecm')</h3>
                <table>
                    <tr>
                        <th>
                        ...
                        <th>
                            <b>@lang('imet-core::oecm_evaluation.KeyElementsImpact.fields.StatusSH')</b>
                        </th>
                        <th>
                            <b>@lang('imet-core::oecm_evaluation.KeyElementsImpact.fields.TrendSH')</b>
                        </th>
                        <th>
                            <b>@lang('imet-core::oecm_evaluation.KeyElementsImpact.fields.EffectSH')</b>
                        </th>
                    </tr>
