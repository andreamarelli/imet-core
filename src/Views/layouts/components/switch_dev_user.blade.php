    ...
    <li>
        ...
        <ul class="language_selector">
            ...
            <li>
                ...
                <form id="switch_to_administrator_user-form" action="{{ route('imet-core::change_user') }}" method="POST" class="d-none">
            ...
            <li>
                ...
                <form id="switch_to_authority_user-form" action="{{ route('imet-core::change_user') }}" method="POST" class="d-none">
            ...
            <li>
                ...
                <form id="switch_to_observatory_user-form" action="{{ route('imet-core::change_user') }}" method="POST" class="d-none">
            ...
            <li>
                ...
                <form id="switch_to_encoder_user-form" action="{{ route('imet-core::change_user') }}" method="POST" class="d-none">
