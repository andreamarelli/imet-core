...
?>
<div id="form-grid">
    @component('modular-forms::page.filters-accordion', ['accordion_title' => trans('imet-core::analysis_report.custom_names'), 'submit_button_label' => $submit_button_label, 'url'=>route('scaling_up_report', ['items' => $pa_ids]), 'request'=>$request, 'method'=>'POST', 'expanded'=>false])
        @slot('filter_content')
