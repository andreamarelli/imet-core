...
foreach(\AndreaMarelli\ImetCore\Models\Imet\v1\Modules\Context\MenacesPressions::$groupByCategory as $i => $category){
    $group = $category[0];
    $category_index = $i+1;
    $view_groupTable = injectCategoryTitle($view_groupTable, $definitions['module_key'], $group, $i, trans('imet-core::form/v1/context.MenacesPressions.categories.title'.$category_index));
}
