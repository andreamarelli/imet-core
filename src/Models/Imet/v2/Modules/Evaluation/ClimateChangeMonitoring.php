...
class ClimateChangeMonitoring extends Modules\Component\ImetModule_Eval
{
    ...
    public function __construct(array $attributes = []) {
        ...
        $this->module_fields = [
            ...
            ['name' => 'EvaluationScore',  'type' => 'blade-imet-core::components.rating-0to3WithNA',   'label' => trans('form/imet/v2/evaluation.ClimateChangeMonitoring.fields.EvaluationScore')],
