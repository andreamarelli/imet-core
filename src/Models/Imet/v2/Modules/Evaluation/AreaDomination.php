...
class AreaDomination extends Modules\Component\ImetModule_Eval
{
    ...
    public function __construct(array $attributes = []) {
        ...
        $this->module_fields = [
            ['name' => 'Patrol',            'type' => 'blade-imet-core::components.rating-0to3',   'label' => trans('form/imet/v2/evaluation.AreaDomination.fields.Patrol')],
            ['name' => 'RapidIntervention', 'type' => 'blade-imet-core::components.rating-0to3',   'label' => trans('form/imet/v2/evaluation.AreaDomination.fields.RapidIntervention')],
