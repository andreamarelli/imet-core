...
class Networks extends Modules\Component\ImetModule
{
    ...
    public function __construct(array $attributes = []) {
        ...
        $this->module_title = trans('imet-core::form/v2/context.Networks.title');
        $this->module_fields = [
            ['name' => 'NetworkName',  'type' => 'text-area',   'label' => trans('imet-core::form/v2/context.Networks.fields.NetworkName')],
            ['name' => 'ProtectedAreas',  'type' => 'imet-core::selector-wdpa_multiple',   'label' => trans('imet-core::form/v2/context.Networks.fields.ProtectedAreas')],
        ];

        $this->module_groups = [
            'group0' => trans('imet-core::form/v2/context.Networks.groups.group0'),
            'group1' => trans('imet-core::form/v2/context.Networks.groups.group1'),
            'group2' => trans('imet-core::form/v2/context.Networks.groups.group2'),
        ];
