...
//    protected $fixed_rows = true;
    ...
    public function __construct(array $attributes = []) {
        ...
        $this->module_title = trans('imet-core::form/v2/context.Equipments.title');
        $this->module_fields = [
            ['name' => 'Resource',  'type' => 'text-area',   'label' => trans('imet-core::form/v2/context.Equipments.fields.Resource')],
            ['name' => 'AdequacyLevel',  'type' => 'blade-imet-core::components.rating-0to3',   'label' => trans('imet-core::form/v2/context.Equipments.fields.AdequacyLevel')],
            ['name' => 'Comments',  'type' => 'text-area',   'label' => trans('imet-core::form/v2/context.Equipments.fields.Comments')],
        ];

        $this->predefined_values = [
            'field' => 'Resource',
            'values' => [
                'group0' => trans('imet-core::form/v2/context.Equipments.predefined_values.group0'),
                'group1' => trans('imet-core::form/v2/context.Equipments.predefined_values.group1'),
                'group2' => trans('imet-core::form/v2/context.Equipments.predefined_values.group2'),
                'group3' => trans('imet-core::form/v2/context.Equipments.predefined_values.group3'),
                'group4' => trans('imet-core::form/v2/context.Equipments.predefined_values.group4'),
                'group5' => trans('imet-core::form/v2/context.Equipments.predefined_values.group5'),
                'group6' => trans('imet-core::form/v2/context.Equipments.predefined_values.group6'),
                'group7' => trans('imet-core::form/v2/context.Equipments.predefined_values.group7'),
                'group8' => trans('imet-core::form/v2/context.Equipments.predefined_values.group8'),
                'group9' => trans('imet-core::form/v2/context.Equipments.predefined_values.group9'),
                'group10' =>trans('imet-core::form/v2/context.Equipments.predefined_values.group10'),
                'group11' =>trans('imet-core::form/v2/context.Equipments.predefined_values.group11'),
                'group12' =>trans('imet-core::form/v2/context.Equipments.predefined_values.group12')
            ]
        ];

        $this->module_groups = [
            'group0' => trans('imet-core::form/v2/context.Equipments.groups.group0'),
            'group1' => trans('imet-core::form/v2/context.Equipments.groups.group1'),
            'group2' => trans('imet-core::form/v2/context.Equipments.groups.group2'),
            'group3' => trans('imet-core::form/v2/context.Equipments.groups.group3'),
            'group4' => trans('imet-core::form/v2/context.Equipments.groups.group4'),
            'group5' => trans('imet-core::form/v2/context.Equipments.groups.group5'),
            'group6' => trans('imet-core::form/v2/context.Equipments.groups.group6'),
            'group7' => trans('imet-core::form/v2/context.Equipments.groups.group7'),
            'group8' => trans('imet-core::form/v2/context.Equipments.groups.group8'),
            'group9' => trans('imet-core::form/v2/context.Equipments.groups.group9'),
            'group10' => trans('imet-core::form/v2/context.Equipments.groups.group10'),
            'group11' => trans('imet-core::form/v2/context.Equipments.groups.group11'),
            'group12' => trans('imet-core::form/v2/context.Equipments.groups.group12'),
        ];

        $this->ratingLegend = trans('imet-core::form/v2/context.Equipments.ratingLegend');
