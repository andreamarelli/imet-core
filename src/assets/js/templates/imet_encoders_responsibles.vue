<template>
    ...
    <div class="imet_responsible">
        ...
        <div v-if="to_be_shown['internal'].length>0">
            <b>{{ Locale.getLabel('imet-core::form/common.responsible_internal') }}</b>:<br />
            <ul>
        ...
        <div v-if="to_be_shown['external'].length>0">
            <b>{{ Locale.getLabel('imet-core::form/common.responsible_external') }}</b>:
            <ul>
        ...
        <div v-if="to_be_shown['encoders'].length>0">
            <b>{{ Locale.getLabel('imet-core::form/common.encoders') }}</b>:
            <ul>
