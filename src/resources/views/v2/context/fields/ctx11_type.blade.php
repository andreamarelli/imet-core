...
<p class="max-w-3xl gray-400 text-sm pl-5 pb-3"><i>{{ trans('imet-core::v2_context.GeneralInfo.type_info.terrestrial') }}</i></p>

<label class="radio-inline">
    <input name="{{ $id }}" {!! $vue_attributes !!} type="radio" value="marine_and_coastal" />
    {{ trans('imet-core::v2_lists.PaType.marine_and_coastal') }}
</label>
<p class="max-w-3xl gray-400 text-sm pl-5 pb-3"><i>{{ trans('imet-core::v2_context.GeneralInfo.type_info.marine_and_coastal') }}</i></p>
...
<p class="max-w-3xl gray-400 text-sm pl-5 pb-3"><i>{{ trans('imet-core::v2_context.GeneralInfo.type_info.oecm') }}</i></p>
...
<p class="max-w-3xl gray-400 text-sm pl-5 pb-3"><i>{{ trans('imet-core::v2_context.GeneralInfo.type_info.icca') }}</i></p>
